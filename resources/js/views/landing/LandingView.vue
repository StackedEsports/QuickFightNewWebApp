...
// Dynamically load the Sellix embed script
onMounted(() => {
        ...
        <div class="row g-0 justify-content-center text-center">
          <div class="col-md-10 pt-7 pb-9">
            ...
            <h1 class="h1 fw-black mb-3">
              Stacked Esports Solutions
            </h1>
            <p class="fs-5 fw-medium text-muted mb-4 mx-xl-8">
              Your one stop shop for esports tournament organizing. Run your tournaments directly on
              <span class="text-body-color fw-semibold">Discord</span>, with our
              <span class="text-body-color fw-semibold">QuickFight bot.</span>
              Notable features include <span class="text-body-color fw-semibold">Match management</span>,
              <span class="text-body-color fw-semibold">Stats tracking</span>,
              <span class="text-body-color fw-semibold">Mapban</span> and
              <span class="text-body-color fw-semibold">much more!</span>.
            </p>
            ...
            <a class="btn btn-alt-primary py-2 px-3 m-1" href="https://pixelcave.com/products/oneui" v-click-ripple>
              ...
              <span class="ms-2">Learn more</span>
    ...
    <div id="one-vue-hero-after" class="bg-body-light">
      <div class="content content-full">
        <div class="px-lg-8 text-center">
          <BaseBlock fx-shadow class="overflow-hidden" content-class="p-2" style="margin-top: -200px">
            <img class="w-100" src="/assets/media/various/pexels-photo-896851.jpeg" alt="Hero Promo Light Dashboard" />
          </BaseBlock>
        </div>
        <div class="row py-5">
          ...
          <div class="row mb-5">
            <div class="col-md-6">
              <h2 class="h1 fw-bold mb-2">
                Made for both
                <span class="fw-normal">Players and Tournament Organizers</span>
              </h2>
          ...
          <div class="col-6">
            <BaseBlock transparent class="bg-flat-lighter">
              <div class="py-4 py-md-7 text-center">
                <i class="fa-fw fa-5x fa-solid fa-gamepad text-flat"></i>
              </div>
            </BaseBlock>
          </div>
          <div class="col-6">
            <BaseBlock transparent class="bg-danger-light">
              <div class="py-4 py-md-7 text-center">
                <i class="fa-solid fa-5x fa-chess-rook text-city"></i>
              </div>
            </BaseBlock>
          </div>
        </div>
            ...
            <div class="w-100 mb-5 mb-md-0 px-lg-6 position-relative">
              <div class="row">
                <div class="col-6 col-md-12">
                  <BaseBlock transparent class="bg-body-light">
                    <div class="py-4 py-md-6 text-center">
                      <svg width="8rem" height="8rem" viewBox="0 0 410 404" fill="none"
                ...
                <div class="col-6 col-md-12">
                  <BaseBlock transparent class="bg-body-light">
                    <div class="py-4 py-md-6 text-center">
                      <svg height="8rem" width="8rem" viewBox="0 0 319 477" xmlns="http://www.w3.org/2000/svg">
                        <linearGradient id="a">
                        ...
                        <g fill="none" fill-rule="evenodd" transform="translate(-34 -24)">
                          <path
                            ...
                            fill="url(#b)" transform="rotate(-38 137.962 147.099)" />
                          <path
                            ...
                            fill="url(#c)" transform="rotate(52 240.026 189.003)" />
                          <path
                            ...
                            fill="url(#d)" transform="rotate(7 8.977 277.799)" />
                          <path
    ...
    <div id="one-vue-call-to-action" class="bg-body-extra-light">
      <div class="content content-full">
        <div class="py-5 py-md-8 text-center">
          ...
          <a class="btn btn-success py-2 px-3 m-1"
            href="https://pixelcave.com/products/oneui-vue-edition?purchase=true&ref=demo" v-click-ripple>
            <i class="fa fa-fw fa-shopping-cart opacity-50"></i>
            <span class="ms-2">Purchase</span>
          </a>
          <RouterLink :to="{ name: 'landing' }" class="btn btn-primary py-2 px-3 m-1" v-click-ripple>
      ...
      <div class="content py-5">
        <div class="row fs-sm fw-medium">
          ...
          <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
            <a class="fw-semibold" href="https://pixelcave.com/products/oneui-vue-edition">{{ store.app.name + " " +
              store.app.version }}</a>
