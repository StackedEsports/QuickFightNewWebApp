...
const BackendBoxedImage1 = () =>
    import ("@/views/backend-boxed/Image1View.vue");
const BackendBoxedImage2 = () =>
    import ("@/views/backend-boxed/Image2View.vue");
const BackendBoxedSearch = () =>
    import ("@/views/backend-boxed/SearchView.vue");

// Backend: Dashboard
const BackendDashboard = () =>
    import ("@/views/backend/DashboardView.vue");

// Backend: Blog
const BackendBlogClassic = () =>
    import ("@/views/backend/blog/ClassicView.vue");
const BackendBlogList = () =>
    import ("@/views/backend/blog/ListView.vue");
const BackendBlogGrid = () =>
    import ("@/views/backend/blog/GridView.vue");
const BackendBlogStory = () =>
    import ("@/views/backend/blog/StoryView.vue");
...
const BackendForumTopics = () =>
    import ("@/views/backend/forum/TopicsView.vue");
...
const BackendBlocksForms = () =>
    import ("@/views/backend/blocks/FormsView.vue");
const BackendBlocksThemed = () =>
    import ("@/views/backend/blocks/ThemedView.vue");
const BackendBlocksApi = () =>
    import ("@/views/backend/blocks/ApiView.vue");
...
const BackendElementsSteps = () =>
    import ("@/views/backend/elements/StepsView.vue");
...
const BackendLayoutApi = () =>
    import ("@/views/backend/layout/ApiView.vue");
...
const SpecialsStatus = () =>
    import ("@/views/specials/StatusView.vue");
const SpecialsInstallation = () =>
    import ("@/views/specials/InstallationView.vue");
const SpecialsCheckout = () =>
    import ("@/views/specials/CheckoutView.vue");
const SpecialsComingSoon = () =>
    import ("@/views/specials/ComingSoonView.vue");

// Auth
const AuthSignIn = () =>
    import ("@/views/auth/SignInView.vue");
const AuthSignIn2 = () =>
    import ("@/views/auth/SignIn2View.vue");
const AuthSignIn3 = () =>
    import ("@/views/auth/SignIn3View.vue");
const AuthSignUp = () =>
    import ("@/views/auth/SignUpView.vue");
const AuthSignUp2 = () =>
    import ("@/views/auth/SignUp2View.vue");
const AuthSignUp3 = () =>
    import ("@/views/auth/SignUp3View.vue");
const AuthLock = () =>
    import ("@/views/auth/LockView.vue");
const AuthLock2 = () =>
    import ("@/views/auth/Lock2View.vue");
const AuthLock3 = () =>
    import ("@/views/auth/Lock3View.vue");
const AuthReminder = () =>
    import ("@/views/auth/ReminderView.vue");
const AuthReminder2 = () =>
    import ("@/views/auth/Reminder2View.vue");
const AuthReminder3 = () =>
    import ("@/views/auth/Reminder3View.vue");
const AuthTwoFactor = () =>
    import ("@/views/auth/TwoFactorView.vue");
const AuthTwoFactor2 = () =>
    import ("@/views/auth/TwoFactor2View.vue");
const AuthTwoFactor3 = () =>
    import ("@/views/auth/TwoFactor3View.vue");
            ...
            */
            {
                ...
                children: [{
                    ...
                    {
                        path: "steps",
                        name: "backend-elements-steps",
                        component: BackendElementsSteps,
                    },
                    {
                        path: "animations",
